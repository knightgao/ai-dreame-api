...
const OtherSetting = () => {
  ...
  const openGitHubRelease = () => {
    window.location = 'https://github.com/knightgao/ai-dreame-api/releases/latest';
  };

  const checkUpdate = async () => {
    const res = await API.get('https://api.github.com/repos/knightgao/ai-dreame-api/releases/latest');
